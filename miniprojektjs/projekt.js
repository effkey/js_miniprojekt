class Paragon {
  ...
  addToParagon(raz, numberofClick) {
    ...
    // przyciski do przesuwania kolejnosci w dol i gore

    // var cellOrderButton = row.insertCell();
    // cellOrderButton.setAttribute("id", "order");
    // let out = document.getElementById("order");
    // let upbutton = document.createElement("button");
    // upbutton.setAttribute("class", "up");
    // upbutton.innerHTML = "Do gory";
    // let downbutton = document.createElement("button");
    // downbutton.setAttribute("class", "down");
    // downbutton.innerHTML = "Do dolu";
    // cellOrderButton.append(upbutton);
    // cellOrderButton.append(downbutton);
    // var buttonUp = document.getElementsByClassName("up");
    // if (buttonUp) {
    //   for (let i = 0; i < buttonUp.length; i++) {
    //     buttonUp[i].addEventListener("click", (event) => {
    //       console.log("tak to jest up");
    //     });
    //   }
    // }
    this.razem = raz;
